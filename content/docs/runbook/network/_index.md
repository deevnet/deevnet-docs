...
Upgrading the Omada controller is under [Lifecycle](/docs/runbook/lifecycle/omada-controller-upgrade/), and recovering it
under [Recovery](/docs/runbook/recovery/omada-controller-recovery/).
