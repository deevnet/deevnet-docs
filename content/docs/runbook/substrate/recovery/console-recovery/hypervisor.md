...
weight: 2
aliases:
  - /docs/runbook/recovery/console-recovery/hypervisor/
...
is on the switch — see [access switch](/docs/runbook/substrate/recovery/console-recovery/access-switch/).
...
[Building Infrastructure](/docs/runbook/substrate/building-recovery/).
