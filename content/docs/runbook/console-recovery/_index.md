...
[segmentation prerequisites](/docs/runbook/network-migration/prerequisites/) already
...
- [Network segmentation troubleshooting](/docs/runbook/network-migration/troubleshooting/) — faults that are not lockouts
