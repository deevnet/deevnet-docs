...
| **Status** | **In progress**. Done on 2026-09-15: Steps 1–2 and 5–6; Step 7 for `dv02nms001v01` and `dv02sob001v01`, both rebooted after their first-boot upgrade; Step 8 for the Omada controller on `dv02nms001v01`, with its firewall ports corrected at 22:05Z. Step 9's manual floor is done: the wizard, a local Owner, the automation account and the Open API client. Step 10 stopped the Builder's controller at 23:14Z. Every step that can be done remotely is finished; Steps 3–4 and the four remaining VMs wait for someone at the rack. Steps 3–4 wait for someone at the rack, and the Platform and IoT Backend VMs in Steps 7–8 wait on those. |
