...
weight: 8
aliases:
  - /docs/changes/2026/2026-03-21-flat-network-to-vlans/troubleshooting/
...
- If the builder is unreachable, Omada adoption ([Step 12](/docs/changes/2026/0001-flat-network-to-vlans/port-migration/#step-12-omada-device-adoption)) cannot proceed — but the switch and AP continue to function independently
...
- [ ] **Add dv02rpi003p01, dv02rpi004p01, dv02hyp002p02 port assignments:** These devices were removed from `switch_ports` because they were not connected during migration. Re-add when physically cabled.
