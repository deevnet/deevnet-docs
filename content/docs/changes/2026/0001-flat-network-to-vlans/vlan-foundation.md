...
weight: 2
aliases:
  - /docs/changes/2026/2026-03-21-flat-network-to-vlans/vlan-foundation/
...
**Undo:** [Undo Step 2](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-2)
...
**Undo:** [Undo Step 3](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-3)

---

## Step 4: Trunk Uplink (Tagged VLANs)

Add all VLANs as tagged members on the uplink port. The PVID stays at 1 (the router's untagged traffic continues on VLAN 1). The PVID cutover to blackhole (999) happens in [Step 9b](/docs/changes/2026/0001-flat-network-to-vlans/services-and-routing/#step-9b-trunk-pvid-cutover-to-blackhole) — after OPNsense VLAN interfaces have IPs and the router is reachable via tagged VLANs.
...
**Undo:** [Undo Step 4](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-4)
