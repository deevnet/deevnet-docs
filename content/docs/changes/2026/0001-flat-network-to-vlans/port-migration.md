...
weight: 5
aliases:
  - /docs/changes/2026/2026-03-21-flat-network-to-vlans/port-migration/
...
{{< hint info >}}
**DNS:** New 10.20.x.x addresses will not resolve via DNS until post-migration ([Step 11](#step-11-management-cutover) / [Post-Migration](/docs/changes/2026/0001-flat-network-to-vlans/post-migration/)). This is expected — Ansible uses inventory IPs directly. Use IP addresses for any manual verification during this step.
{{< /hint >}}
...
**Undo:** [Undo Step 10](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-10)
...
2. **Switch management VLAN** — remove the old VLAN 1 management interface. The switch already has a VLAN 99 management IP (`10.20.99.10`) from [Step 5b](/docs/changes/2026/0001-flat-network-to-vlans/builder-cutover/#5b--add-vlan-99-management-ip-to-the-switch).
   ```
   configure
   no interface vlan 1
   end
...
[Undo Step 11](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-11).
...
**Undo:** [Undo Step 12](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-12)
...
**Undo:** [Undo Step 13](/docs/changes/2026/0001-flat-network-to-vlans/undo/#undo-step-13)
