...
- **ADR-0021 — the device credential.** ADR-0020 §2 leaves the mechanism open, and ADR-0012 §3
  defers "identity and PKI" to its own record. Nothing in stage 2 can start until it is written.
