...
**Prerequisites:**
- [Step 4](/docs/migrations/2026-03-21-vlan-migration/vlan-foundation/#step-4-trunk-uplink-tagged-vlans) complete (trunk uplink carrying tagged VLANs)
...
OPNsense default-denies all traffic on new OPT interfaces. This adds temporary pass-all rules via the firewall API so traffic flows during migration. [Step 9](/docs/migrations/2026-03-21-vlan-migration/services-and-routing/#step-9-inter-vlan-firewall-rules) replaces these with proper zone-based policy.
...
The switch is now reachable at both `192.168.10.10` (VLAN 1) and `10.20.99.10` (VLAN 99). The VLAN 1 address is removed in [Step 11](/docs/migrations/2026-03-21-vlan-migration/port-migration/#step-11-management-cutover) after migration completes.
...
See [Undo Step 5](/docs/migrations/2026-03-21-vlan-migration/undo/#undo-step-5), which covers 5b–5d.
